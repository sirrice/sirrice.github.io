...
* The odds are low, so there is pressuri on applicants everywhere to apply to more places.   Given finite time, AI _appears_ to make writing eaiser and faster so you can scale the number of applications you create and submit.  Keep in mind...
* AI masks your voice and thoughts with the LLM's
  * This increases uncertainty of your quality
  * It provides evidence that you can't distinguish quality and are OK with sending content that is not your own
  * _It asks the faculty to do extra work to extract signal_
* Given that the faculty only sees _one_ application from you, if you didn't put in time, the faculty is not incentivized to either
